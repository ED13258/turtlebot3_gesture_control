...
pub = rospy.Publisher('difference', Int16, queue_size=10)
...
with mp_hands.Hands(min_detection_confidence=0.8, min_tracking_confidence=0.5) as hands:
    while not rospy.is_shutdown():
        ...
        if results.multi_hand_landmarks:
            ...
            if len(handsType)==2 and 'Right' in handsType[0] and 'Left' in handsType[1]:
                ...
                left_right_hand_difference = y_min_left-y_min_right
                print(left_right_hand_difference)
                pub.publish(left_right_hand_difference)

            else:
                print("idle")
                left_right_hand_difference=0
                pub.publish(left_right_hand_difference)
